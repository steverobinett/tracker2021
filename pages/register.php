...
<body>
    ...
    <form action="../php/confirmReg.php" method="POST" onsubmit="return validators();">
        ...
        <input type="text" name="userFirst" id="userFirst" placeholder="Required">
        <div class="errorDiv" id="userFirstError"></div>
        <label for="userLast">Last Name:</label>
        <input type="text" name="userLast" id="userLast" placeholder="Required">
        <div class="errorDiv" id="userLastError"></div>
        <label for="userEmail">Email:</label>
        <input type="text" name="userEmail" id="userEmail" placeholder="Required">
